    ...
    internal class TestSolverResults {
        ...
        public void SolveLinearFunction ( ) {
            ...
            SolverND solverNd = SolverND.NdBuilder
                ...
                .Under ( force )
                .Build ( );
            List<LoadState> states = solverNd.Broadcast ( ).Take ( 2 ).ToList ( );
        ...
        public void SolveLinearFunctionSmallIncrements ( ) {
            ...
            SolverND solverNd = SolverND.NdBuilder
                ...
                .Build ( );
            List<LoadState> states = solverNd.Broadcast ( ).TakeWhile ( s => s.Lambda <= 1 ).ToList ( );
        ...
        public void SolveQuadraticFunction ( ) {
            ...
            SolverND solverNd = SolverND.NdBuilder
                ...
                .Build ( );
            List<LoadState> states = solverNd.Broadcast ( ).TakeWhile ( x => x.Lambda <= 1 ).ToList ( );
            AssertSolutionsAreCorrect ( Function , force , states );
        }
        ...
        public void SolveQuadraticFunctionArcLength ( ) {
            ...
            SolverND solverNd = SolverND.NdBuilder
                ...
                .Build ( );
            List<LoadState> states = solverNd.Broadcast ( ).TakeWhile ( x => x.Lambda <= 10 ).ToList ( );
            AssertSolutionsAreCorrect ( Function , force , states );
        }
